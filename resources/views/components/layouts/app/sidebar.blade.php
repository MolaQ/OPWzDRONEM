    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <div x-data="{ open: {{ request()->routeIs(['admin.rentals', 'admin.returns', 'admin.equipment', 'admin.equipment-sets', 'admin.qr-codes', 'admin.equipment.my-reservations', 'admin.equipment.detail']) ? 'true' : 'false' }} }" class="mb-2">
                    <button @click="open = !open" class="flex w-full items-center justify-between px-2 py-2 text-sm font-semibold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition">
                        <span class="flex items-center gap-2">
                    ...
                    <div x-show="open" x-collapse class="mt-1 space-y-1">
                        ...
                        <flux:navlist.item icon="calendar" :href="route('admin.equipment.my-reservations')" :current="request()->routeIs('admin.equipment.my-reservations')" wire:navigate>Moje rezerwacje</flux:navlist.item>
                        @endcan
