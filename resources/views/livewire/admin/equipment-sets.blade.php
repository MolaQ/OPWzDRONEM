<flux:main>
    ...
    @if (session()->has('error'))
        <div class="p-4 bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-200 rounded-lg">
            {{ session('error') }}
        </div>
    @endif
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button
                                            ...
                                            class="p-2 rounded-lg transition {{ $isRented ? 'text-neutral-300 dark:text-neutral-600 cursor-not-allowed' : 'text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900' }}"
                                        ...
                                        <button
                                            ...
                                            class="p-2 text-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-700 rounded-lg transition"
