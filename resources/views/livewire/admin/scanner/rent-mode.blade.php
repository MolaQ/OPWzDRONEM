        ...
        <div class="p-6">
            ...
            <div class="flex gap-3">
                ...
                <button
                    ...
                    class="px-6 py-3 rounded-lg bg-green-600 text-white font-semibold hover:bg-green-700 flex items-center gap-2 border border-green-500/70 dark:border-green-500"
                >
