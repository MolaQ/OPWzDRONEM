<div class="flex-1 overflow-auto p-6">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-neutral-900 dark:text-neutral-100 mb-2">Skaner kodów kreskowych</h1>
            <p class="text-neutral-600 dark:text-neutral-400">Zeskanuj kod ucznia (S) lub sprzętu (E)</p>
        </div>

        <!-- Scanner Input -->
        <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm mb-6">
        ...
        <!-- Results -->
        @if($result)
            <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-lg overflow-hidden">
                <!-- Success Header -->
