            ...
            <div wire:key="post-{{ $post->id }}" class="overflow-hidden border-b border-neutral-200 dark:border-neutral-700 last:border-b-0">
                    <div class="px-4 py-3 flex items-center hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors gap-3">
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0 px-3">
                            <button type="button" wire:click="editPost({{ $post->id }})" class="inline-flex items-center justify-center w-7 h-7 text-neutral-600 border-2 border-neutral-300 hover:border-neutral-400 hover:text-neutral-700 rounded transition-all dark:text-neutral-400 dark:border-neutral-600 dark:hover:border-neutral-500 dark:hover:text-neutral-300" title="Edytuj">
                            ...
                            <button type="button" wire:click="deletePost({{ $post->id }})" wire:confirm="Czy na pewno usunąć ten post?" class="inline-flex items-center justify-center w-7 h-7 text-neutral-600 border-2 border-neutral-300 hover:border-neutral-400 hover:text-neutral-700 rounded transition-all dark:text-neutral-400 dark:border-neutral-600 dark:hover:border-neutral-500 dark:hover:text-neutral-300" title="Usuń">
                ...
                <div class="flex items-start justify-center min-h-full px-4">
                    ...
                    <div class="space-y-3">
                                ...
                                <div class="flex gap-4 items-start">
                                    ...
                                    <div class="flex-1">
                                        <input
                                            ...
                                            wire:model="image"
                                            accept="image/*"
                                            class="w-full rounded-lg bg-white border border-neutral-300 px-3 py-2 text-sm text-neutral-900 file:mr-3 file:py-1.5 file:px-4 file:rounded-md file:border-0 file:text-xs file:font-medium file:bg-white file:text-neutral-900 file:border file:border-neutral-300 file:cursor-pointer hover:file:bg-neutral-50 transition dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-100 dark:file:bg-neutral-700 dark:file:text-white dark:file:border-neutral-600 dark:hover:file:bg-neutral-600"
                                        />
                        ...
                        <button
                            type="submit"
                            form="postForm"
                            class="px-6 py-2.5 rounded-lg text-sm font-semibold transition-all shadow-md flex items-center gap-2
                                   bg-white text-neutral-900 border-2 border-neutral-300 hover:border-neutral-400 hover:shadow-lg
                                   focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-400
                                   dark:bg-neutral-800 dark:text-white dark:border-neutral-600 dark:hover:border-neutral-500 dark:hover:shadow-lg dark:hover:bg-neutral-700"
                        >
