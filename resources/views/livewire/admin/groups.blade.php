                    ...
                    @forelse($groups as $group)
                        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors">
                            ...
                            <td class="py-2 px-3 flex gap-2 justify-center">
                                <button type="button" wire:click="editGroup({{ $group->id }})" class="inline-flex items-center justify-center w-7 h-7 text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition-colors" title="Edytuj">
                                ...
                                <button type="button" wire:click="deleteGroup({{ $group->id }})" wire:confirm="Czy na pewno usunąć tę grupę?" class="inline-flex items-center justify-center w-7 h-7 text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors" title="Usuń">
